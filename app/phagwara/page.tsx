...
const jsonLd = {
  ...
  url: "https://shivamanpowerconsultants.com/phagwara",
...
const trustReasons = [
  ...
  { title: "25+ Years of Trust", desc: "Founded in 1998, serving Phagwara, Nakodar, Jalandhar, and the entire Doaba belt for over two decades." },
  { title: "Just 25 Min from Phagwara", desc: "Our office on Jalandhar Road, Nakodar is easily accessible from Phagwara. Walk-in consultations Monday to Saturday, 9am-6pm." },
