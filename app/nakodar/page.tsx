...
export const metadata: Metadata = {
  ...
  description:
    "Best travel agent & immigration office in Nakodar â€” govt-licensed (RA B-1794), 20+ years. Romania, Schengen, Poland, UAE, Croatia, Saudi & Qatar visas, work permits & overseas recruitment from Nakodar, Punjab.",
  keywords: [
...
const trustReasons = [
  { title: "Walk-in Office on Your Doorstep", desc: "Golden Avenue, Jalandhar Road â€” within 5â€“10 minutes of most Nakodar mohallas. 1 km from Nakodar Bus Stand, 2 km from Nakodar Railway Station. Your hometown RA agency â€” no need to travel to Jalandhar or Chandigarh." },
  { title: "Only Govt-Licensed RA Inside Nakodar City", desc: "Other agents you may see in Nakodar are unlicensed sub-agents who refer your case to bigger agencies in Jalandhar/Chandigarh â€” adding hidden commission. We are the only MEA-licensed (RA B-1794) agency physically operating from inside Nakodar." },
  { title: "Walk-In Without Appointment", desc: "Bring your family, parents, friends â€” no need to call ahead. Sit with our team 30â€“45 minutes, ask everything, no commitment. Open Monâ€“Sat 9 AMâ€“6:30 PM even during peak season." },
  { title: "24 Years of Nakodar Reputation", desc: "Tarsem Lal sir founded Shiva Travel in Nakodar in 2002. Almost every Nakodar family has visited our office, or knows a worker we've placed abroad. Local accountability â€” we live and work in this same neighbourhood." },
  { title: "Direct Employer Contact â€” No Middlemen", desc: "From our Nakodar office we directly call employers in UAE, Saudi, Qatar, Poland, Romania, Croatia. No middleman agent, no sub-agent commission, no false promises that other Nakodar agents make. Direct contracts, direct visa stamping." },
  { title: "Honest Free Consultation", desc: "Bring just an ID and any work certificate. We assess your profile in 30â€“45 minutes for free. If you genuinely qualify for an opening, we explain the next steps. If not, we tell you straight â€” no false hopes, no deposit pressure." },
];

const faqs = [
  { q: "Where exactly is your Nakodar office located?", a: "Shiva Travel & Manpower Consultants is at Golden Avenue, near Sukhjeet Hospital, Jalandhar Road, Nakodar â€” PIN 144040. We are 1 km from Nakodar Bus Stand (5 minutes walk) and 2 km from Nakodar Railway Station. Look for the blue Shiva Travel signboard." },
  { q: "Can I walk in without an appointment from Nakodar?", a: "Yes â€” most of our Nakodar visitors are walk-ins. Open Monday to Saturday, 9 AM to 6:30 PM. The least busy times are 10 AMâ€“12 PM and 3 PMâ€“5 PM. Bring your family, friends, or anyone you want to consult with. No appointment, no charges for first consultation." },
  { q: "Is Shiva Travel the only government-licensed agency in Nakodar?", a: "Yes â€” we are the only MEA-licensed Recruiting Agent (RA B-1794) physically operating from Nakodar city. There are unlicensed Nakodar agents who advertise overseas jobs but actually sub-agent through bigger Jalandhar/Chandigarh agencies, adding hidden commission. We deal directly with employers, fully licensed, fully transparent. Verify at emigrate.gov.in." },
  { q: "Can I get a Romania, Poland or Schengen visa from your Nakodar office?", a: "Yes. We process Romania, Poland, Croatia, Schengen and all major European work visas entirely from our Nakodar office â€” including documentation, skill testing, embassy appointments. No need to travel to Delhi or Chandigarh for European visa processing." },
  { q: "What are the fees for overseas recruitment from Nakodar?", a: "Service charges are written on a notice board in our Nakodar office. Every cost â€” application, GAMCA medical, visa, ticket â€” is explained upfront before any deposit. Charges follow Indian government regulations. No surprise deductions, no hidden commissions." },
  { q: "How do I contact Shiva Travel in Nakodar?", a: "Call +91 98148-20432 or WhatsApp +91 98153-58832. Our Nakodar office on Golden Avenue is open Monâ€“Sat 9 AMâ€“6:30 PM for walk-in consultations. You can also email us at info@shivatravelconsultant.in." },
  { q: "How long does the visa process take from Nakodar?", a: "Gulf countries (UAE, Saudi, Qatar, Kuwait): 30â€“60 days. Europe (Poland 75 days, Romania 90 days, Croatia 90 days). We track every case from our Nakodar office and update you on WhatsApp at each stage." },
  { q: "Is Shiva Travel & Manpower Consultants a genuine agency in Nakodar?", a: "Yes â€” we hold RA License B-1794/PUN/PER/100/5/10094/2022 from the Ministry of External Affairs, valid through June 2027. We are E-Migrate registered, ALMRA Punjab members, and operating from Nakodar since 2002. Verify our license on the official eMigrate.gov.in portal." },
];
    ...
    <>
      ...
      <main style={{ backgroundColor: "#f8f9ff" }}>
        <PageHero
          ...
          description="The most trusted travel agent in Nakodar and govt-licensed immigration office. Based right here on Jalandhar Road since 2002. Romania, Schengen, Poland, UAE â€” every visa processed from our Nakodar office."
          ...
          <div style={{ maxWidth: 1300, margin: "0 auto", padding: "0 32px" }}>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              <p style={{ fontFamily: "var(--font-body)", fontSize: 16, color: "#43474d", lineHeight: 1.7, maxWidth: 640, margin: "0 auto" }}>
                We process work visas, tourist visas, and immigration paperwork for 20+ countries â€” all from our Nakodar office. No need to travel to Jalandhar or Chandigarh.
              </p>
            </div>
        ...
        <section style={{ padding: "80px 0", backgroundColor: "#f8f9ff" }}>
          <div style={{ maxWidth: 1300, margin: "0 auto", padding: "0 32px" }}>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(1.75rem, 3vw, 2.25rem)", fontWeight: 700, color: "#0b1c30", marginBottom: 12 }}>Frequently Asked Questions â€” Nakodar Office</h2>
              <p style={{ fontFamily: "var(--font-body)", fontSize: 16, color: "#43474d", lineHeight: 1.7, maxWidth: 640, margin: "0 auto" }}>
