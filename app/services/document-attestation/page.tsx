...
const faqs = [
  ...
  { q: "How long does the full attestation process take?", a: "The timeline depends on the type of document and the destination country. Typically, the complete process â€” notary, state HRD/Home Department, MEA, and embassy attestation â€” takes 15 to 30 working days. Gulf country attestations are usually faster (15-20 days) because of established processing channels." },
  ...
  return (
    <>
      ...
      <main style={{ backgroundColor: "#f8f9ff" }}>
        <PageHero
          kicker="Attestation & Apostille Services"
          ...
          description="Every overseas job requires attested documents. We manage the entire chain â€” Notary â†’ State HRD â†’ MEA â†’ Embassy â€” so you don't run between Chandigarh, Delhi and embassy consulates. Everything handled from our Nakodar office."
          primaryCta={{ label: "Start Attestation Process", href: "/contactus" }}
          stats={[
            { num: "10,000+", label: "Documents Attested" },
            { num: "All", label: "Embassies Covered" },
        ...
        <section style={{ padding: "80px 0", backgroundColor: "#f8f9ff" }}>
          <div style={{ maxWidth: 1300, margin: "0 auto", padding: "0 32px" }}>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(1.75rem, 3vw, 2.25rem)", fontWeight: 700, color: "#0b1c30", marginBottom: 12 }}>The Attestation Process â€” Step by Step</h2>
              <p style={{ fontFamily: "var(--font-body)", fontSize: 16, color: "#43474d", lineHeight: 1.7, maxWidth: 640, margin: "0 auto" }}>
        ...
        {/* ===== RELATED SERVICES â€” internal linking ===== */}
        ...
        <section style={{ padding: "96px 24px", maxWidth: 1300, margin: "0 auto", background: "linear-gradient(135deg, #000c2f 0%, #001f5d 100%)", textAlign: "center", position: "relative", overflow: "hidden", borderRadius: 24 }}>
          ...
          <div style={{ maxWidth: 640, margin: "0 auto", position: "relative" }}>
            ...
            <p style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "rgba(255,255,255,0.4)", marginBottom: 36 }}>
              Bring your original documents. We manage the rest â€” from notary to embassy.
            </p>
