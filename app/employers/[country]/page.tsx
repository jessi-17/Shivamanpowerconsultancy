...
export const metadata: Metadata = {
  title: "For Employers ÃƒÂ¢Ã¢â€šÂ¬Ã¢€Å“ Hire Skilled Workers from India | Shiva Manpower Consultants",
  description:
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", padding: "80px 32px", maxWidth: 800 }}>
          <p style={{ fontFamily: "var(--font-body)", fontSize: "clamp(1.1rem, 2vw, 1.35rem)", color: "rgba(255,255,255,0.9)", lineHeight: 1.7, marginBottom: 40, maxWidth: 700, margin: "0 auto 40px" }}>
            If your company needs Indian workers for Construction, Oil &amp; Gas, Hospitality, or Industrial sectors ÃƒÂ¢Ã¢â€šÂ¬Ã¢€Â look no further. Send in a request and we&apos;ll get back to you within 24 Hours.
          </p>
          <Link
            href="/contactus"
            style={{
