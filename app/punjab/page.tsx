...
const cities = [
  { name: "Nakodar", href: "/nakodar", desc: "Our head office. Walk-in consultations Monâ€“Sat at Golden Avenue, Jalandhar Road." },
  { name: "Jalandhar", href: "/jalandhar", desc: "Serving Jalandhar district â€” workers travel from Kartarpur, Phillaur, Nurmahal." },
  ...
  { name: "Hoshiarpur", href: "/hoshiarpur", desc: "Hoshiarpur, Dasuya, Mukerian & Mahilpur â€” Europe & Gulf placements." },
  { name: "Nawanshahr", href: "/nawanshahr", desc: "Serving SBS Nagar â€” Banga, Balachaur, Garhshankar for overseas work." },
];
...
const visaServices = [
  ...
  { country: "UAE Visa", desc: "Dubai, Abu Dhabi & Sharjah work visas â€” construction, hospitality, driving.", href: "/visa/uae" },
  { country: "Croatia Visa", desc: "Skilled & semi-skilled worker visas â€” construction & tourism.", href: "/visa/croatia" },
...
const trustReasons = [
  { title: "Statewide Coverage â€” 6 Doaba Cities, One Office", desc: "We are the only fully-licensed Recruiting Agent operating from inside Punjab's Doaba belt with structured outreach to Nakodar, Jalandhar, Kapurthala, Phagwara, Hoshiarpur and Nawanshahr. Workers from Amritsar, Ludhiana, Tarn Taran, Moga also visit us regularly â€” the geographic reach matters because it means we understand worker profiles from every Punjab sub-region." },
  { title: "Punjab Worker Skill-Matching Network", desc: "Punjab workers have distinct regional skill clusters â€” Hoshiarpur woodcraft, Jalandhar sports goods, Kapurthala engineering diplomas, Banga sugar mill, Phagwara hospitality. We map each cluster to its highest-paying overseas destination: Hoshiarpur woodworkers to Romania, Banga sugar workers to Poland food processing, etc. State-level expertise that smaller city agents cannot offer." },
  { title: "MEA RA B-1794 â€” Punjab's Most-Verifiable Agency", desc: "We are licensed by the Ministry of External Affairs (RA B-1794/PUN/PER/100/5/10094/2022, valid through June 2027), E-Migrate registered, ALMRA Punjab member. Verify on emigrate.gov.in â€” search 'Punjab' and you'll find our agency listed among very few that hold an actual government license in the state." },
  { title: "5,000+ Punjab Placements in 20+ Countries", desc: "Across UAE (1,800+), Saudi Arabia (1,200+), Qatar (600+), Poland (450+), Romania (400+), Kuwait, Bahrain, Croatia, Schengen Europe â€” Punjabi workers placed via Shiva Travel constitute one of the largest Doaba-origin overseas workforce networks. Real volume, real long-term tracking." },
  { title: "Direct Employer Network â€” Not a Reseller", desc: "Most Punjab recruitment offices are sub-agents who route your case through bigger agencies in Delhi/Mumbai â€” adding silent commission to your fee. We have direct MoUs with 500+ overseas employers, negotiated directly. No middle layer means lower charges and faster decisions on your case." },
  { title: "Walk-In Office Serving All of Punjab", desc: "Golden Avenue, Jalandhar Road, Nakodar â€” central in the Doaba belt and reachable from Jalandhar (30 min), Kapurthala (30 min), Phagwara (40 min), Hoshiarpur (1 hr), Nawanshahr (1 hr). Open Monâ€“Sat 9 AMâ€“6:30 PM. No appointment required for Punjab candidates." },
];

const faqs = [
  { q: "What are the benefits of using a manpower consultancy in Punjab for overseas recruitment?", a: "Using a government-licensed manpower consultancy in Punjab for overseas recruitment gives you eight concrete benefits over a freelance agent or direct application: (1) Legal protection â€” only MEA-licensed Recruiting Agents (RA) can legally process overseas employment for ECR-passport holders; Shiva Travel holds Licence B-1794. (2) Verified employers â€” every Gulf, European or Schengen employer is vetted via Demand Letter, Power of Attorney, and Wakala before any candidate is signed. (3) End-to-end document chain â€” passport, MEA attestation, GAMCA medical, embassy stamping, E-Migrate clearance handled under one roof. (4) Transparent fees â€” capped by Indian government rules; no broker commissions or hidden deductions. (5) Local accessibility â€” walk-in office in Nakodar serving Jalandhar, Kapurthala, Phagwara, Hoshiarpur, Nawanshahr and all of Doaba. (6) Punjabi/Hindi-speaking counsellors who understand local trade skills (welding, masonry, drivers, hospitality, farm work). (7) Faster placement â€” established employer relationships across UAE, Saudi Arabia, Qatar, Kuwait, Poland, Romania and Croatia. (8) Post-departure support â€” airport pickup, on-arrival paperwork, family contact, and grievance handling through ALMRA Punjab. A Punjab-based consultancy combines legal safety with proximity, which freelance agents cannot offer." },
  { q: "How does an overseas recruitment agency in Punjab help with job placement in Romania?", a: "A Punjab-based MEA-licensed recruitment agency like Shiva Travel & Manpower Consultants handles the entire Romania placement from Nakodar: sourcing the Romanian employer offer, processing the Aviz de munca work permit, MEA attestation of documents, Romanian embassy long-stay (D/AM) visa, mandatory E-Migrate clearance, flight booking, and airport pickup in Bucharest/Cluj. Typical roles include welder, mason, plumber, helper, factory worker, driver and hotel staff at Rs.95,000â€“Rs.1.6 lakh/month with employer-paid accommodation." },
  { q: "Which is the best manpower consultancy in Punjab?", a: "Shiva Travel & Manpower Consultants is the best government-licensed manpower consultancy in Punjab. We hold RA License B-1794 from the Ministry of External Affairs and have been serving Punjab since 2002 â€” 20+ years with 5,000+ workers placed across UAE, Saudi Arabia, Qatar, Kuwait, Poland and Romania. Our walk-in office in Nakodar serves Jalandhar, Kapurthala, Phagwara, Hoshiarpur and Nawanshahr." },
  ...
  { q: "Which is the best immigration office in Punjab?", a: "Shiva Travel & Manpower Consultants is one of the most trusted government-licensed immigration offices in Punjab. Located in Nakodar (Golden Avenue, Jalandhar Road), we serve the entire Doaba region â€” Jalandhar, Kapurthala, Phagwara, Hoshiarpur, Nawanshahr â€” with complete visa and immigration assistance for Gulf and European countries." },
  { q: "How do I find the best recruitment agency in Punjab?", a: "Look for three things: (1) Government license â€” every legitimate agency must hold an MEA-issued RA license. We hold RA B-1794. (2) Years in business â€” Punjab has many agencies but few have 20+ years. We started in 2002. (3) Transparent fees â€” we communicate every cost upfront, no hidden charges." },
  { q: "Which cities in Punjab do you serve?", a: "Our head office is in Nakodar, but we serve all of Doaba and beyond â€” Jalandhar, Kapurthala, Phagwara, Hoshiarpur, Nawanshahr (SBS Nagar), Ludhiana and Amritsar. Workers from across Punjab visit our Nakodar office for overseas placements." },
  { q: "What is the fees structure of best recruitment agency in Punjab?", a: "Shiva Travel & Manpower Consultants maintains minimal and transparent service charges as per Indian government regulations. Every cost â€” application, medical, visa, ticket â€” is communicated upfront. No hidden fees, no surprise deductions, no broker commissions. This is one of the reasons we are considered Punjab's best recruitment agency." },
  ...
  return (
    <>
      ...
      <main style={{ backgroundColor: "#f8f9ff" }}>
        <PageHero
          kicker="Punjab's Best Govt-Licensed Recruitment Agency Since 2002"
          title="Travel agent, immigration & manpower consultancy in Punjab."
          highlight="in Punjab."
          chips={["Govt-Licensed RA B-1794", "ALMRA Member", "Doaba Coverage", "20+ Years"]}
          description="Punjab's best government-licensed travel agent, immigration office and overseas recruitment agency. Based in Nakodar since 2002 â€” 5,000+ workers placed from Jalandhar, Kapurthala, Phagwara, Hoshiarpur, Nawanshahr."
          primaryCta={{ label: "Book Free Consultation", href: "/contactus" }}
          stats={[
            { num: "5,000+", label: "Placed from Punjab" },
            { num: "6", label: "Doaba Districts" },
            { num: "20+", label: "Years" },
          ]}
          image={{ src: "/shiva-manpower-nakodar-office-punjab.webp", alt: "Punjab's best govt-licensed travel agent and overseas recruitment agency office" }}
          imageSeal={{ title: "Headquartered in Nakodar", subtitle: "Serving all of Punjab Â· Govt-Licensed RA B-1794" }}
          ...
          <div style={{ maxWidth: 1300, margin: "0 auto", padding: "0 32px" }}>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              <p style={{ fontFamily: "var(--font-body)", fontSize: 16, color: "#43474d", lineHeight: 1.7, maxWidth: 640, margin: "0 auto" }}>
                Headquartered in Nakodar, we are the best overseas recruitment agency for the entire Doaba region â€” Jalandhar, Kapurthala, Phagwara, Hoshiarpur and Nawanshahr.
              </p>
            </div>
        ...
        <section style={{ padding: "80px 0", backgroundColor: "#ffffff", borderTop: "1px solid #e5e7eb" }}>
          <div style={{ maxWidth: 1300, margin: "0 auto", padding: "0 32px" }}>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              <p style={{ fontFamily: "var(--font-body)", fontSize: 16, color: "#43474d", lineHeight: 1.7, maxWidth: 640, margin: "0 auto" }}>
                Work visas, tourist visas and immigration paperwork for 20+ countries â€” processed entirely from our Punjab office.
              </p>
            </div>
        ...
        <section style={{ padding: "80px 0", backgroundColor: "#f8f9ff", borderTop: "1px solid #e5e7eb" }}>
          <div style={{ maxWidth: 1300, margin: "0 auto", padding: "0 32px" }}>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              <p style={{ fontFamily: "var(--font-body)", fontSize: 16, color: "#43474d", lineHeight: 1.7, maxWidth: 640, margin: "0 auto" }}>
                The most trusted, government-licensed overseas recruitment agency in Punjab â€” with 20+ years of proven placements.
              </p>
            </div>
        ...
        <section style={{ padding: "80px 0", backgroundColor: "#f8f9ff" }}>
          <div style={{ maxWidth: 1300, margin: "0 auto", padding: "0 32px" }}>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              <p style={{ fontFamily: "var(--font-body)", fontSize: 16, color: "#43474d", lineHeight: 1.7, maxWidth: 640, margin: "0 auto" }}>
                Most-asked questions from job seekers across Punjab â€” Jalandhar, Kapurthala, Hoshiarpur and beyond.
              </p>
            </div>
        ...
        <section style={{ padding: "96px 24px", maxWidth: 1300, margin: "0 auto", background: "linear-gradient(135deg, #000c2f 0%, #001f5d 100%)", textAlign: "center", position: "relative", overflow: "hidden", borderRadius: 24 }}>
          ...
          <div style={{ maxWidth: 640, margin: "0 auto", position: "relative" }}>
            ...
            <p style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "rgba(255,255,255,0.4)", marginBottom: 36 }}>
              Serving Jalandhar, Kapurthala, Phagwara, Hoshiarpur, Nawanshahr â€” walk-in Monâ€“Sat, 9 AMâ€“6:30 PM.
            </p>
