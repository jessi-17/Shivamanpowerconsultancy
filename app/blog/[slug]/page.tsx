...
export default async function BlogPostPage({
  ...
  // Insert mid-article CTA after roughly 40% of the content
  const midCta = `
    <div style="margin:36px 0;padding:24px;border-radius:14px;background:linear-gradient(135deg,#001233,#001845);text-align:center">
      <p style="font-family:var(--font-display);font-size:18px;font-weight:800;color:#fff;margin-bottom:8px;line-height:1.3">
        Want expert guidance for your overseas journey?
      </p>
      <p style="font-family:var(--font-body);font-size:14px;color:rgba(255,255,255,0.65);margin-bottom:16px;line-height:1.6">
        Talk to our licensed consultants — zero fees, 25+ years of trust.
      </p>
      <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap">
        <a href="https://wa.me/919815358832?text=${encodeURIComponent("Hi, I was reading your blog and I'm interested in overseas jobs.")}"
           target="_blank" rel="noopener noreferrer"
           style="display:inline-flex;align-items:center;gap:6px;padding:10px 20px;border-radius:10px;background:#25D366;color:#fff;font-family:var(--font-display);font-size:13px;font-weight:700;text-decoration:none">
        ...
        <a href="/contactus"
           style="display:inline-flex;align-items:center;gap:6px;padding:10px 20px;border-radius:10px;background:#2563eb;color:#fff;font-family:var(--font-display);font-size:13px;font-weight:700;text-decoration:none">
          Apply Now — It&apos;s Free
        </a>
      </div>
    </div>
  ...
  // Split content and inject mid-article CTA at ~40%
  const paragraphs = rawHtml.split("</p>");
  const insertAt = Math.floor(paragraphs.length * 0.4);
  paragraphs.splice(insertAt, 0, midCta);
  const articleHtml = paragraphs.join("</p>");
  ...
  return (
    <>
      ...
      <main className="full-width-page">
        ...
        {/*  SOCIAL SHARING                                               */}
        {/* ============================================================ */}
        <section style={{ backgroundColor: "#ffffff", padding: "0 24px 48px" }}>
          <div style={{ maxWidth: 700, margin: "0 auto", borderTop: "1px solid #e2e8f0", paddingTop: 28 }}>
            <p style={{
              fontFamily: "var(--font-display)", fontSize: 14,
              fontWeight: 700, color: "#0b1c30", marginBottom: 14,
            }}>
              Share this article
            </p>
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              ...
              <a
                ...
                style={{
                  display: "inline-flex", alignItems: "center", gap: 8,
                  padding: "10px 20px", borderRadius: 10,
                  backgroundColor: "#0f1419", color: "#fff",
                  fontFamily: "var(--font-display)", fontSize: 13,
                  fontWeight: 700, textDecoration: "none",
                }}
              >
