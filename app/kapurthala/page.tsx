...
const trustReasons = [
  ...
  { title: "25+ Years of Trust", desc: "Founded in 1998, serving Kapurthala, Nakodar, Jalandhar, and the entire Doaba belt for over two decades." },
  { title: "Just 15 Min from Kapurthala", desc: "Our office on Jalandhar Road, Nakodar is easily accessible from Kapurthala. Walk-in consultations Monday to Saturday, 9am-6pm." },
